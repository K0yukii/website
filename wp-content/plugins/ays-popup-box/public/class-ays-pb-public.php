        ...
        if(isset($popupbox['onoffswitch']) && $popupbox['onoffswitch'] == 'On'){
            ...
            if ($ays_pb_bg_image_mobile !== '') {
                ...
                if ($background_gradient == 'on') {
                    $ays_pb_bg_image_mobile_styles = "background-image: linear-gradient(".$pb_gradient_direction.",".$background_gradient_color_1.",".$background_gradient_color_2.") !important;";
                } else {
