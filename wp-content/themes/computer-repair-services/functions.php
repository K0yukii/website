...
function computer_repair_services_preloader() {
  ...
  $computer_repair_services_logo_max_height = get_theme_mod('computer_repair_services_logo_max_height');
	...
	if(get_theme_mod('computer_repair_services_preloader_bg_color') == '') {
		$computer_repair_services_preloader_bg_color = '';
	}
	if(get_theme_mod('computer_repair_services_preloader_dot_1_color') == '') {
		$computer_repair_services_preloader_dot_1_color = '';
	}
	if(get_theme_mod('computer_repair_services_preloader_dot_2_color') == '') {
		$computer_repair_services_preloader_dot_2_color = '';
	}
	$computer_repair_services_theme_color_css = '
...
function computer_repair_services_getpage_css($hook) {
	wp_enqueue_script( 'computer-repair-services-admin-script', get_template_directory_uri() . '/inc/admin/js/computer-repair-services-admin-notice-script.js', array( 'jquery' ) );
    wp_localize_script( 'computer-repair-services-admin-script', 'computer_repair_services_ajax_object',
...
define('COMPUTER_REPAIR_SERVICES_LIVE_DEMO',__('https://www.themagnifico.net/demo/computer-repair-services/','computer-repair-services'));
}
if ( ! defined( 'COMPUTER_REPAIR_SERVICES_GET_PREMIUM_PRO' ) ) {
define('COMPUTER_REPAIR_SERVICES_GET_PREMIUM_PRO',__('https://www.themagnifico.net/themes/computer-wordpress-theme/','computer-repair-services'));
}
if ( ! defined( 'COMPUTER_REPAIR_SERVICES_PRO_DOC' ) ) {
define('COMPUTER_REPAIR_SERVICES_PRO_DOC',__('https://www.themagnifico.net/eard/wathiqa/computer-repair-services-pro-doc/','computer-repair-services'));
}
...
function computer_repair_services_info_page() {
	...
	<div class="wrap about-wrap computer-repair-services-add-css">
			...
			<div class="feature-section three-col">
				...
				<div class="col">
					<div class="widgets-holder-wrap">
						...
						<p><a target="_blank" href="<?php echo esc_url( COMPUTER_REPAIR_SERVICES_GET_PREMIUM_PRO ); ?>" class="button button-primary get">
		...
		<div class="computer-repair-services-button-container">
			<a target="_blank" href="<?php echo esc_url( COMPUTER_REPAIR_SERVICES_GET_PREMIUM_PRO ); ?>" class="button button-primary get">
    ...
    if ( !$dismissed) { ?>
        <div class="updated notice notice-success is-dismissible notice-get-started-class" data-notice="get_started" style="background: #f7f9f9; padding: 20px 10px; display: flex;">
	    	...
	    	<div class="tm-admin-content" style="padding-left: 30px; align-self: center">
	        	...
	        	<a class="admin-notice-btn button button-primary button-hero" target="_blank" href="<?php echo esc_url( COMPUTER_REPAIR_SERVICES_PRO_DOC ); ?>"><?php esc_html_e( 'Documentation', 'computer-repair-services' ) ?></a>
